package com.example.sys9.myapplication;
...
class JSONImageCustomAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        View view1 ;
        view = LayoutInflater.from(context).inflate(R.layout.show_data_item_json,viewGroup,false);
        view1 = view;
